...
Using the above specifications, the decision rule that the *brixtonhealth* calculator calculated is 33, actual $\alpha$ error is 0.0110, and actual $\beta$ error is 0.0057.

Calculating $\alpha$ and $\beta$ given decision rule, $d^*$ = 33 are:
