...
* Population size is very large relative to the sample size such that computing sample sizes and their errors (type 1 and type 2) can be accomplished using normal distribution and binomial distribution, respectively. 
* One-sided test
...
## 4. Verify the squeac calculator calculation

### 4.1 Verify calculation: input parameters set 1

To check the calculation of *squeac* calculator, we use input parameters as follow: lower standard = 50%, upper standard = 80%, upper error level = 10%, and lower error level = 10%. These input parameters are similar to those in Lemeshow and Taber (1991).
